...
Defines the Player interface with unique IDs, the squad file organization under `src/data/squads/` with a barrel index, and migration of existing squad files to include player IDs.
