...
Defines the visual design and data integration for player cards in the MatchSquad view, including large avatars, faded jersey number watermarks, position badges, goal badges, scorer highlighting, and real data integration.
