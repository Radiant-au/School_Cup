# standings-table-redesign

## Purpose

Defines the FotMob-inspired standings table redesign: compact column layout, team logo data model, inline crests in the table, and a shared TeamCrest component.
