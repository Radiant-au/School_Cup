...
Defines the curated top-scorers data exports, the "Scorers" bottom-nav tab that replaces the previous knockout/Cup tab, the layout of the `TopScorersTab` view (male/female toggle, ranked scorer cards, player preview modal), and the squad-joined card rendering.
