...
Defines how the `fifaOwner` admin panel authenticates against Supabase Auth (email + password), how the admin routes are guarded, how the session persists, and how sign-out behaves.
