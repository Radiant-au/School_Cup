...
Defines the linting, formatting, and typecheck developer tooling for the project: ESLint with a flat config, Prettier with config and ignore files, and the npm scripts that surface them.
