...
Defines the match goal events data model (MATCH_EVENTS array), goal aggregation per player per match, goal-scorer sorting in the squad view, and removal of legacy mock data.
